...
schedule <- data.frame(dates = c("2026-09-01",
                                 "2026-09-08",
                                 "2026-09-15",
                                 "2026-09-22",
                                 "2026-09-29"),
...
# Get month as a word for Subject; use the second entry, as sometimes the last 
# session of the preceding month is included in the schedule data.frame
month_word <- as.character(lubridate::month(x = schedule$dates[2],
                                            label = TRUE,
                                            abbr = FALSE))
...
Subject: R/Python labs in `r month_word`
...
_All sessions will be 9-11 am (MST) on Tuesday_. Most workshops will take place 
in person in the [Data Studios of the Main Library](https://new.library.arizona.edu/visit/spaces/data-studio).

Drop-in sessions will be offered in hybrid format, in the Data 
Studios and online at [https://arizona.zoom.us/j/89160294963](https://arizona.zoom.us/j/89160294963).

**Note**: Drop-in help for R and Python is _always_ available, even when a 
...
+ A tentative schedule of upcoming sessions is also available at
...
+ Stay up to date with the schedule by signing up for the University of Arizona 
