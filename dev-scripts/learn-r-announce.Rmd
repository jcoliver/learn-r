...
schedule <- data.frame(dates = c("2020-01-14",
                                 "2020-01-21",
                                 "2020-01-28"),
                       lessons = c(0, -1, -1))
```
...
_All sessions will be 9-11 am on Tuesday in the Data Studios of the [Main Library](https://new.library.arizona.edu/visit/spaces/data-studio)_. To get the most out of these workshops, participants should bring a laptop with [R and RStudio installed](https://jcoliver.github.io/learn-r/000-setup-instructions.html).
