...
> ###Challenge 1  
Use ANOVA to test for differences in sepal width among the three species. What are the values of the _F_-statistic and the p-value?
...
> In both pairwise comparisons, petal lengths were significantly different between the two species.
