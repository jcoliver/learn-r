...
> ###Challenge 1  
Use ANOVA to test for differences in sepal width among the three species. What is the _F_-statistic?
...
> ###Challenge 3  
Test for a relationship between life expectancy and natural log of GDP for the 1952 data. How much of the variation in life expectancy is explained by the variation in (transformed) GDP?
...
> ###Challenge 3  
Test for a relationship between life expectancy and log base 2 of GDP for the 1952 data. How does life expectancy change with a four-fold increase in GDP?
...
gapminder.1952$log2GDP <- log2(gapminder.1952$gdpPercap)

# Run linear model
lifeExp.v.gdp <- lm(lifeExp ~ log2GDP, data = gapminder.1952)
summary(lifeExp.v.gdp)
```
...
>`## log2GDP        6.1204      0.4593  13.326   < 2e-16 ***`
