...
usually a big green button "New repository" you can click on.  

![](images/new-repo.png)  

For this lesson enter `simulate-data` in the repository name field, "A 
repository for simulating and plotting data" in the description field, and 
click the "Create repository" button. Give yourself a pat on the back: You're 
using GitHub!
...
RStudio to this repository through the command line interface of RStudio 
