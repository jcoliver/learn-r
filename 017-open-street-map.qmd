...
libs <- c("dplyr", "ggplot2", "osmdata", "sf")
...
install.packages("dplyr")   # For chaining together OpenStreetMap commands
```
...
When using packages like osmdata and dplyr, we have to take one additional 
