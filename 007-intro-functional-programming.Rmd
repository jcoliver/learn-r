...
Hmmmm...that's an odd warning. Let's add some reporting code to see if we can figure out what it's doing. Update the `RegressSimple` function to print the name of the predictor:
...
Start by getting the names of the variables and set up a data frame to hold the values we want to print:
...
+ Access individual elements of the output to print p & r
+ Write print.RegressSimple function
