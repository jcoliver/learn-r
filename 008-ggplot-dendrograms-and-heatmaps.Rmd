...
We can make those labels a bit smaller and closer to the dendrogram:
...
We need to start by transforming data to a "long" format, where each row only contains values for one measurement. For example, if our first two rows of data are:

**insert table here**

we want to transform it to this format:
...
Take a look at the combined figure:
