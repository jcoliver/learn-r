...
```{r load-libraries-quiet, echo = FALSE}
...
panel). If you see an error that includes something like

```
Error in sourceUTF8(fullpath, envir = new.env(parent = sharedEnv)) : 
  Error sourcing /home/jcoliver/Desktop/shiny-test/app.R
```
