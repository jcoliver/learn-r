...
boxplot(formula = m2 ~ species, data = otter, main = "m2", cex = 0.8)
boxplot(formula = m3 ~ species, data = otter, main = "m3", cex = 0.8)
boxplot(formula = m5 ~ species, data = otter, main = "m5", cex = 0.8)
boxplot(formula = m6 ~ species, data = otter, main = "m6", cex = 0.8)

# Restore graphing defaults
par(mfrow = c(1, 1), las = 0)
```
Indeed, where _E. lutris_ has higher values of m2 and m5 than _P. brasiliensis_, the reverse is true for m3 and m6. The second principal component is thus describing variation in _relative_, not absolute, sizes of these four different measurements.
