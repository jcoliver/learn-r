...
3. Add subheadings to PCA & DFA sections
4. ~~Provide rationale for why PCA~~
5. ~~Add (advanced) code for detecting the number of clusters~~
6. ~~Provide spreadsheet software info (Excel, LibreOffice) on 000-setup-instructions page~~
7. Add DFA section
