...
2. In DFA section
  + Brief interpretation (part one) - explain `table`
  + Simplify graph of posterior probabilities
3. Add references
...
### Final script
The final script for running the DFA and creating the barplot would then be:
```{r, eval = FALSE}
