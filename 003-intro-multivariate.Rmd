...
2. Redo PCA section explaining the second principal component; skip the pairwise
plot, maybe no plots altogether...
3. In DFA section
  + Brief interpretation (part one)
  + Plot results (first two LDAs)
  + Revise Brief interpretation (part two)
...
### Plotting DFA assignment probabilities
