...
# Create a data frame with 12 rows of data, to hold "new album"
new_album <- data.frame()
...
song_data <- swift_data %>%
  ...
  mutate(mode_name = as.factor(mode_name)) # convert one text column to factor

# Create distributions of each song characteristic


# Sample from those distributions of each characteristic, repeating the process
# for a total of 12 times

# Store the data in a single data frame
