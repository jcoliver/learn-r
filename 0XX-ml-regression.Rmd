...
+ Explain why we do this for all folds (idiosyncracies in training/testing split)
+ Do the loop iterations (or comment the process)
+ Calculate mean
+ Do boxplot

```{r boxplot-vectors, eval = FALSE, echo = FALSE}
# Example of a boxplot with two vectors
boxplot(x = iris$Sepal.Length[iris$Species == "setosa"], 
