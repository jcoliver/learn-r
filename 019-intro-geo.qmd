...
> Question 2: Why would we use negative values instead of the letters W and S 
...
> Question 3: For our cropped data, how many calculations would this conversion 
require?
...
> Question 4: What are some differences between the map we see on our screen 
and reality?
...
> Question 5: What is the name of the coordinate system that EPSG 5070 refers 
to?
...
> Question 6: What are the values stored in the `temp_cols` variable?
