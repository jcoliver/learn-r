...
8. Add fold data for testing/training
9. Run glm
10. Predict probability values
11. Calculate thresholds and plot results
...
glm_model <- glm(pa~., data = testing)

# Get predicted values from the model
glm_predict <- predict(bioclim_data, glm_model)

# Print predicted values
plot(glm_predict)
```

OK, it is a map, but what does it mean?
