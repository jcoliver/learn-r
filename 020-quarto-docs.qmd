...
it could be a URL to an online image. For our purposes, we will use an online 
image of an *Iris* flower. Once again, open up your favorite web browser and 
find an image of one of the three *Iris* species (*Iris setosa*, 
*Iris versicolor*, or *Iris virginica*). I am going to use an image of 
*Iris virginica* at [https://upload.wikimedia.org/wikipedia/commons/thumb/f/f8/Iris_virginica_2.jpg/500px-Iris_virginica_2.jpg](https://upload.wikimedia.org/wikipedia/commons/thumb/f/f8/Iris_virginica_2.jpg/500px-Iris_virginica_2.jpg).
To add this image to my report, I will add a sentence to the **Discussion** and 
use the image syntax described above.
...
![Image of _I. virginica_ by Eric Hunt](https://upload.wikimedia.org/wikipedia/commons/thumb/f/f8/Iris_virginica_2.jpg/500px-Iris_virginica_2.jpg)
```
...
![Updating a style in Microsoft Word](images/quarto-style-word.png)

![Updating a style in LibreOffice Writer](images/quarto-style-libre.png)
...
to update the styles for Header 2 and Normal text. Once you finished, save the changes and close this .docx file.
